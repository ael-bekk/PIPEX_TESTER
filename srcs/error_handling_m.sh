...
#    Updated: 2022/02/17 16:08:26 by ael-bekk         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
printf "${WHITE}\tcatds /dev/random | ls                                   : ${RESET}"
timeout "$1" "in_file" "catds /dev/random" "ls" "outfile"
find_smae_err=`cat my_error | grep -a "command not found" | wc -l`
ls > outfile2
...
printf "${WHITE}\tcsdfat | wsdfc -cl                                       : ${RESET}"
...
printf "${WHITE}\t/bin/catsdc | wcss -cl                                   : ${RESET}"
...
find_smae_err2=`cat my_error | grep "command not found" | wc -l`
...
printf "${WHITE}\t/bin/caqwdt  | /bin/lsqwd -ls                            : ${RESET}"
...
printf "${WHITE}\t/srcs/a.out  | ls                                        : ${RESET}"
